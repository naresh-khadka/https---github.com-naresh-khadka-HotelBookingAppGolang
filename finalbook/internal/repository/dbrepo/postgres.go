...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	...
	stmt := `insert into reservations (first_name, last_name, email, phone, country, start_date,
...
func (m *postgresDBRepo) AllReservations() ([]models.Reservation, error) {
	...
	query := `
		select r.id, r.first_name, r.last_name, r.email, r.phone, r.country, r.start_date, 
...
func (m *postgresDBRepo) UpdateReservation(u models.Reservation) error {
	...
	query := `
		update reservations set first_name = $1, last_name = $2, email = $3, phone = $4, country=$5, updated_at = $6
		where id = $7
`

...
import (
	...
	"github.com/naresh-khadka/bookings/internal/driver"
	"github.com/naresh-khadka/bookings/internal/forms"
	"github.com/naresh-khadka/bookings/internal/helpers"
	"github.com/naresh-khadka/bookings/internal/models"
	"github.com/naresh-khadka/bookings/internal/render"
	"github.com/naresh-khadka/bookings/internal/repository"
	"github.com/naresh-khadka/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	username := r.Form.Get("username") // Changed from "email" to "username"
	password := r.Form.Get("password")

	form := forms.New(r.PostForm)
	form.Required("username", "password") // Changedfrom "email" to "username"
	// Remove the email validation, as  now i am using the username
	...
	id, _, err := m.DB.Authenticate(username, password) // Change from "email" to "username"
	if err != nil {
